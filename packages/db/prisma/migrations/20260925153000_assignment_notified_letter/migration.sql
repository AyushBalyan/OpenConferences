-- Rewrite assignment.notified as a programme-committee review request.
...
<p style="margin:0 0 16px;font-size:15px;line-height:1.65;color:#52525b;">We would be grateful if you could review the assigned conference paper "{{paperTitle}}".</p>
<p style="margin:0 0 16px;font-size:15px;line-height:1.65;color:#52525b;">You are kindly requested to complete the review and submit your comments/recommendations within 7 days of receiving this email.</p>
...
This message was sent by {{conferenceName}}.$letter$,
